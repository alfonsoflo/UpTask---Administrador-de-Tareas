(function(){
    ...
    function totalPendientes(){
        ...
        const pendinetesRadio = document.querySelector('#pendientes');

        if(totalPendientes.length === 0){
            pendinetesRadio.disabled = true;
        }else{
            pendinetesRadio.disabled = false;
        }
    }
    ...
    function mostrarAlerta(mensaje,tipo,referencia){
        ...
        // Inserta alerta antes del <legend></legend>, no dentro
    ...
    // Consultar servidor para añadir nueva tarea al proyecto actual
    async function agregarTarea(tarea){
        ...
        try {
            const url = 'http://localhost:2000/api/tarea';
            const respuesta = await fetch(url, {
                method: 'POST',
                body: datos
            });
    ...
    async function actualizarTarea(tarea){
        ...
        try {
            const url = 'http://localhost:2000/api/tarea/actualizar';
            const respuesta = await fetch(url,{
                method: 'POST',
                body: datos
            });
    ...
    function confirmarEliminarTarea(tarea){
        ...
        async function eliminarTarea(tarea){
            ...
            try {
                const url = 'http://localhost:2000//api/tarea/eliminar';
                const respuesta = await fetch(url, {
                    method: 'POST',
                    body: datos
                });
